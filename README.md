...
It list all error codes defined in the project together with some metadata.
The report format is standardized by this JSON-Schema.

* [0.1.0 (current)](error_code_report-0.1.0.json) [(reference)](https://exasol.github.io/schemas/error_code_report-0.1.0/index.html)
